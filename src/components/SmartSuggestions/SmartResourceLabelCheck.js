...
export const SmartResourceLabelCheck = ({ label = '' }) => {
    ...
    return (
        <SmartSuggestions
            tooltipContent={
                <>
                    <p className="m-0 mb-2">Based on the label you provided, we try to advice how your resource should be structured.</p>
                    {isLoading && (
