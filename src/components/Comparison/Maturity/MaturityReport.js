...
function MaturityReport(props) {
    ...
    const maturityLevelMessage = (currentLevel, uniqueReviewsProperties, mostSelectedReviewNumber) => {
        ...
        switch (currentLevel) {
            ...
            case 2:
                if (
                    uniqueReviewsProperties !== null &&
                    typeof uniqueReviewsProperties === 'object' &&
                    Array.isArray(uniqueReviewsProperties) === false
                ) {
                    if (Object.keys(uniqueReviewsProperties).length > 0) {
                        ...
                        return (
                            <>
                                <span>
                                    The reviewers have recomended to add these properties to your comparison: (
                                    <span style={{ color: 'red' }}>
                                        some of the recommended properties might have been removed because it is already in the comparison itself
                                    </span>
                                    )
                                </span>
                ...
                <>
                    ...
                    <TableContainerStyled>
                        <Table bordered hover className="m-0">
                            <thead>
                                <tr>
                                    <td style={{ width: '20%', fontWeight: 'bold' }}>Maturity Level</td>
                                    <td style={{ width: '80%', fontWeight: 'bold' }}>Explaination</td>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr style={props.maturityLevel == 2 ? { backgroundColor: '#f7eaec' } : {}}>
                                    ...
                                    <td>{maturityLevelMessage(2, props.uniqueReviewsProperties, props.mostSelectedReviewNumber)}</td>
                                </tr>
                                <tr style={props.maturityLevel == 3 ? { backgroundColor: '#f7eaec' } : {}}>
                                    ...
                                    <td key="2">{maturityLevelMessage(3, props.uniqueReviewsProperties, props.mostSelectedReviewNumber)}</td>
                                </tr>
