...
import { AbstractDisplacementState, SelectionLayerModel } from '@projectstorm/react-canvas-core';
import { LinkModel, PointModel } from '@projectstorm/react-diagrams-core';
...
export default class SelectionBoxState extends AbstractDisplacementState {
    ...
    allowSelection(model) {
        return !(model instanceof LinkModel) && !(model instanceof PointModel);
    }
}
