...
export const STATEMENT_BROWSER_ADD_CONTRIBUTION_OBJECT = 'STATEMENT_BROWSER_ADD_CONTRIBUTION_OBJECT';
...
export const SAVE_META_INFORMATION = 'SAVE_META_INFORMATION';
export const SAVE_AUTHOR_ORCID = 'SAVE_AUTHOR_ORCID';
export const RESET_META_INFORMATION_STORE = 'RESET_META_INFORMATION_STORE';
