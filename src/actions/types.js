...
// VIEW ALL PAPERS
export const ADD_BEGINNING_STATEMENTS = 'ADD_BEGINNING_STATEMENTS';
export const ADD_ENDING_STATEMENTS = 'ADD_ENDING_STATEMENTS';
export const ADD_LOADED_PAPERS = 'ADD_LOADED_PAPERS';
