...
// Comparison
export const COMPARISON_SET_VISUALIZATIONS = 'COMPARISON_SET_VISUALIZATIONS';
export const COMPARISON_SET_COMPARISON_OBJECT = 'COMPARISON_SET_COMPARISON_OBJECT';
export const COMPARISON_CLEAR_COMPARISON_ID = 'COMPARISON_CLEAR_COMPARISON_ID';
export const COMPARISON_SET_DOI = 'COMPARISON_SET_DOI';
export const COMPARISON_SET_PREVIOUS_VERSION = 'COMPARISON_SET_PREVIOUS_VERSION';
export const COMPARISON_SET_RESEARCH_FIELD = 'COMPARISON_SET_RESEARCH_FIELD';
export const COMPARISON_SET_CONFIGURATION = 'COMPARISON_SET_CONFIGURATION';
export const COMPARISON_SET_PREDICATES_LIST = 'COMPARISON_SET_PREDICATES_LIST';
export const COMPARISON_SET_CONTRIBUTIONS_LIST = 'COMPARISON_SET_CONTRIBUTIONS_LIST';
export const COMPARISON_SET_CONFIGURATION_ATTRIBUTE = 'COMPARISON_SET_CONFIGURATION_ATTRIBUTE';
export const COMPARISON_SET_CONTRIBUTIONS = 'COMPARISON_SET_CONTRIBUTIONS';
export const COMPARISON_SET_DATA = 'COMPARISON_SET_DATA';
export const COMPARISON_SET_PROPERTIES = 'COMPARISON_SET_PROPERTIES';
export const COMPARISON_SET_FILTER_CONTROL_DATA = 'COMPARISON_SET_FILTER_CONTROL_DATA';
export const COMPARISON_SET_MATRIX_DATA = 'COMPARISON_SET_MATRIX_DATA';
export const COMPARISON_SET_SHORT_LINK = 'COMPARISON_SET_SHORT_LINK';
export const COMPARISON_SET_LOADING_METADATA = 'COMPARISON_SET_LOADING_METADATA';
export const COMPARISON_SET_FAILED_LOADING_METADATA = 'COMPARISON_SET_FAILED_LOADING_METADATA';
export const COMPARISON_SET_FAILED_LOADING_RESULT = 'COMPARISON_SET_FAILED_LOADING_RESULT';
export const COMPARISON_SET_LOADING_RESULT = 'COMPARISON_SET_LOADING_RESULT';
export const COMPARISON_SET_PROVENANCE = 'COMPARISON_SET_PROVENANCE';
export const COMPARISON_SET_CREATED_BY = 'COMPARISON_SET_CREATED_BY';
export const COMPARISON_SET_ERRORS = 'COMPARISON_SET_ERRORS';
