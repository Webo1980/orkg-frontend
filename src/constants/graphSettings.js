export const PREDICATES = {
    ...
    TEMPLATE_IS_FLASH_CARD: 'isFlashCard',
    SHACL_TARGET_CLASS: 'sh:targetClass',
    SHACL_PROPERTY: 'sh:property',
    SHACL_PATH: 'sh:path',
    SHACL_MIN_COUNT: 'sh:minCount',
    SHACL_MAX_COUNT: 'sh:maxCount',
    SHACL_ORDER: 'sh:order',
    SHACL_CLOSED: 'sh:closed',
    SHACL_MIN_INCLUSIVE: 'sh:minInclusive',
    SHACL_MAX_INCLUSIVE: 'sh:maxInclusive',
    SHACL_PATTERN: 'sh:pattern',
    SHACL_CLASS: 'sh:class',
    SHACL_DATATYPE: 'sh:datatype',
    HAS_PART: 'HasPart',
