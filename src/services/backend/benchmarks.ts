...
export const getBenchmarksByResearchFieldId = (rfId: string): Promise<Predicate> =>
    submitGetRequest(`${benchmarksUrl}summary/research-field/${encodeURIComponent(rfId)}`);
