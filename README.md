...
| ESLINT_NO_DEV_ERRORS               | ✅ Used     | 🚫 Ignored  | When set to `true`, ESLint errors are converted to warnings during development. As a result, ESLint output will no longer appear in the error overlay.                                                                                                                                                                                                                                                                                                                                | DISABLE_ESLINT_PLUGIN               | ✅ Used     | ✅ Used  | When set to true, eslint-webpack-plugin will be completely disabled.                                                                                                                                                                                                                                                                                                                                                                              |
                                              |
